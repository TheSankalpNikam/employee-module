...
public class EmployeeInfo
{
    ...
    EmployeeInfo(int employeeId, String name, String lastname, String emailid, String number, int countryId, int cityId, int status, int userId) {
        this.employeeId = employeeId;
        this.name = name;
        this.lastname = lastname;
        this.emailid = emailid;
    ...
    EmployeeInfo(int employeeId, String name, String lastname, String emailid, String number, String countryName, int cityId, int status, int userId) {
        this.employeeId = employeeId;
        this.name = name;
        this.lastname = lastname;
        this.emailid = emailid;
