...
function checkEmployee()
{
    ...
    if (trim(document.employeeForm.fathername.value) == "")
    {
        Swal.fire({
            title: "Please enter Father Name.",
            didClose: () => {
                document.employeeForm.fathername.focus();
            }
        })
        return false;
    }
    if (validnamewithand(document.employeeForm.fathername) == false)
    {
        return false;
    }
    //end 
    ...
    if (validemailid(document.employeeForm.emailid) == false)
    {
        return false;
    }
