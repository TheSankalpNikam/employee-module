                                                    ...
                                                    <table id="tech-companies-1" class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th><span><b>Father Name</b></span></th>
                                                                <th><span><b>Email id</b></span></th>
                                                                <th><span><b>Number</b></span></th>
...
%>
                                                            <tr class='hand_cursor' href='javascript: void(0);'>
                                                                ...
                                                                <td class="hand_cursor" href='javascript: void(0);' onclick="javascript: showDetail('<%= info.getEmployeeId()%>');"><%= info.getFathername() != null ? info.getFathername() : ""%></td>
