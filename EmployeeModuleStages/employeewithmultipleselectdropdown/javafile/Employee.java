...
public class Employee extends Base 
{
    ...
    public EmployeeInfo getEmployeeDetailById(int employeeId)
    {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT t_employee.s_name, t_employee.s_lastname, t_employee.s_emailid, t_employee.s_number, t_employee.s_gender, t_employee.i_countryid, t_city.s_name , t_employee.s_prof, t_employee.s_description, t_employee.i_status, t_employee.s_empfilename, t_employee.i_cityid FROM t_employee  ");
        sb.append("left join t_city on (t_employee.i_cityid = t_city.i_cityid) ");
        ...
        try
        {
            ...
            rs = pstmt.executeQuery();
            String name, lastname, emailid, number, gender, cityName, profColumn, description , empfilename;
            ...
            while (rs.next())
            {
                ...
                profColumn = rs.getString(8);
                description = rs.getString(9) != null ? rs.getString(9) : "";
                status = rs.getInt(10);
                empfilename = rs.getString(11);
                cityId = rs.getInt(12);
                info = new EmployeeInfo(employeeId, name, lastname, emailid, number, gender, countryId, cityName, profColumn, description ,status, empfilename, cityId, 0); 
            }
        }
    ...
    public EmployeeInfo getEmployeeDetailByIdforDetail(int employeeId)
    {
        EmployeeInfo info = null;
        StringBuilder sb = new StringBuilder();
        sb.append("select t_employee.s_name, t_employee.s_lastname, t_employee.s_emailid, t_employee.s_number, t_employee.s_gender, t_country.s_name, t_city.s_name, t_employee.s_prof, t_employee.s_description, t_employee.i_status, t_employee.s_empfilename from t_employee ");
        sb.append("left join t_country on (t_employee.i_countryid = t_country.i_countryid) ");
        sb.append("left join t_city on (t_employee.i_cityid = t_city.i_cityid) ");
        ...
        try
        {
            ...
            rs = pstmt.executeQuery();
            String name, lastname, emailid, number, gender, countryName, cityName, profColumn, description, empfilename;
            ...
            while (rs.next())
            {
                ...
                info = new EmployeeInfo(employeeId, name, lastname, emailid, number, gender, countryName, cityName, profColumn, description, status, empfilename,0); 
            }
            rs.close();            
        }
        catch (Exception exception)
    ...
    public int createEmployee(EmployeeInfo info)
    {
        ...
        try
        {
            ...
            sb.append("(s_name, s_lastname, s_emailid , s_number, s_gender, i_countryid, i_cityid, s_prof, s_description, i_status, s_empfilename, i_userid, ts_regdate, ts_moddate) ");
            sb.append("values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
            String query = (sb.toString()).intern();
            sb.setLength(0);
            ...
            pstmt.setString(++scc, info.getProfColumn());
    ...
    {
       String query = ("Select i_employeeid, s_name, s_lastname, s_emailid, s_number, s_gender, i_countryid, i_cityid, s_prof, s_description, s_empfilename FROM t_employee where i_status = 1 order by  s_name ");
        try
        {
            pstmt = conn.prepareStatement(query);
            rs = pstmt.executeQuery();
            int id, countryId, cityId;
            String name, lastname, emailid, number, gender, profColumn, description, empfilename;
