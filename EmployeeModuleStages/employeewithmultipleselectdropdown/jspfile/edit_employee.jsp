...
<html lang="en">
    ...
    <%
        ...
        String message = "", ids = "", clsmessage = "red_font";
        ...
        if (message != null && (message.toLowerCase()).indexOf("success") != -1) 
        {
            ...
            if (session.getAttribute("PROF_IDs") != null) {
                        ids = (String) session.getAttribute("PROF_IDs");
                                    ...
                                    <div class="row d-none1">
                                        ...
                                        <div class="row col-lg-12">											
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                <label class="form_label">Hobbies</label>
                                                <select name="profColumn" id="expColumnmultiselect_dd" multiple="multiple" class="form-select">
                                                    <option value="1" <% if (employee.checkToStr(ids, "1")) {%>selected<%}%>>Cricket</option>
                                                    <option value="2" <% if (employee.checkToStr(ids, "2")) {%>selected<%}%>>Reading</option>
                                                    <option value="3" <% if (employee.checkToStr(ids, "3")) {%>selected<%}%>>Trekking</option>
                                                    <option value="4" <% if (employee.checkToStr(ids, "4")) {%>selected<%}%>>Cycling</option>
                                                    <option value="5" <% if (employee.checkToStr(ids, "5")) {%>selected<%}%>>Sleeping</option>
                                                    <option value="6" <% if (employee.checkToStr(ids, "6")) {%>selected<%}%>>Running</option>
                                                </Select>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-12 form_group">
