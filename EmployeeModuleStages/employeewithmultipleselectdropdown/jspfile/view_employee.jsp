                                        ...
                                        <div class="row d-none1">  
                                            ...
                                            <div class="row col-lg-12">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-4 form_group">
                                                    ...
                                                    <span class="form-control"><%= employee.getNameFromId(info.getProfColumn()) != null && !employee.getNameFromId(info.getProfColumn()).equals("") ? employee.getNameFromId(info.getProfColumn()) : "&nbsp;"%></span>
                                                </div>
                                                <div class="row">
