...
public class Employee extends Base 
{
    ...
    public EmployeeInfo getEmployeeDetailById(int employeeId)
    {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("SELECT s_name, s_lastname,s_emailid, s_number, i_countryid, i_cityid , s_description, i_status, s_empfilename FROM t_employee where i_employeeid = ? ");
        String query = sb.toString().intern();
        sb.setLength(0);
        try
        {
            ...
            while (rs.next())
            {
                ...
                info = new EmployeeInfo(employeeId, name, lastname, emailid, number, countryId, cityId, description ,status, empfilename,0); 
            }
        }
